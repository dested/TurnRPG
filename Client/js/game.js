...
game.controller('TurnRPGGameCtrl',['$scope',function ($scope) {
  ...
  $scope.model.showPeople = false;

  $scope.model.togglePeople = function () {
    $scope.model.showPeople = !$scope.model.showPeople;
    window.gameBoard.gameModel.showPeople = $scope.model.showPeople;
  };
